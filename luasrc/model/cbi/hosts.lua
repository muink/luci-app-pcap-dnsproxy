...
local input    = "/etc/pcap_dnsproxy/Hosts.raw"
local usrinput = "/etc/pcap_dnsproxy/Hosts.conf"
local usrcfg   = "/etc/pcap_dnsproxy/user/Hosts"
...
m = SimpleForm("pcap-dnsproxy", nil,
	...
	.. translatef("For further information "
		...
		.. "check the online documentation</a>", translate("https://github.com/chengr28/Pcap_DNSProxy/blob/master/Documents/ReadMe.en.txt#L706")))
