...
local input = "/etc/pcap-dnsproxy/IPFilter.conf"
...
s = m:section(SimpleSection, nil,
	translate("This form allows you to modify the content of the pcap-dnsproxy IPFilter configuration file (")
		.. translate(input)
		.. translate(").")
	.. "<br/>"
	.. translatef("For further information "
		.. "<a href=\"%s\" target=\"_blank\">"
		.. "check the online documentation</a>", "https://github.com/chengr28/Pcap_DNSProxy/blob/master/Documents/ReadMe.en.txt#L891"))
